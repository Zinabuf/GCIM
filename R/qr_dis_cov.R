...
#' Covariate Data File for Discovery Dataset with quantitative exposure as an outcomes for the reverse direction. 
#'
...
#'   \item{quantitative outcome}{A quantitative outcome}
#'   #' }
#'
#' @usage data(qr_dis_cov)
#' @docType data
#' @keywords datasets
#' @name qr_dis_cov
NULL
