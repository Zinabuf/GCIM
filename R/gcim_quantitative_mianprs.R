...
#' with quantitative outcomes using the main effects of Polygenic Risk Scores (PRS) of the exposure.
...
#' @examples
#' \dontrun{
#' # Method 1: Using GxEprs PRS_quantitative outputs directly
...
#' 
#' result <- gcim_q1("Qphe_target.txt", "Qexp_target.txt", 
#'                  Add_PRS = q, Int_PRS = r, Cov_PRS = p)
#' 
#' }
gcim_q1 <- function(qp_tar_phen, qp_tar_cov, Add_PRS = NULL, Int_PRS = NULL, Cov_PRS = NULL,
