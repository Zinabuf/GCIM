...
# add_prs_obj <- PRS_quantitative(plink_path, "DummyData", summary_input = add)    # Additive PRS
# int_prs_obj <- PRS_quantitative(plink_path, "DummyData", summary_input = gxe)    # Interaction PRS
# cov_prs_obj <- PRS_quantitative(plink_path, "DummyData", summary_input = trd)    # Covariate PRS
# 
...
# cat("R-squared:", result$r_squared, "\n")
# cat("Adjusted R-squared:", result$adj_r_squared, "\n")
# cat("Residual standard error:", result$residual_se, "\n")
# cat("F-statistic:", result$f_statistic[1], "on", result$f_statistic[2], "and", result$f_statistic[3], "DF\n")
# cat("AIC:", result$aic, "\n")
# cat("BIC:", result$bic, "\n")
# 
