...
All GWAS, GWEIS, and polygenic risk score (PRS) construction steps are performed using the GxEprs R package, while the regression analyses for both binary and quantitative outcomes are conducted using the GCIM R package</div>. 
